...
{
    [Serializable]
    public abstract class UnitEquipmentManager<TUnit, TEquipSlots> : Modifier<TUnit>, IUnitEquipmentManager<TUnit, TEquipSlots>
        ...
        where TEquipSlots : Enum
    {
        ...
        {
            if (CheckSlotExists(equipment.EquipmentSlot) && CheckSlotNotFull(equipment.EquipmentSlot))
            {
